...
void SCDetectorConstruction::DefineGeometryParameters()
{
    ...
    //============================= Pb Cylinder ===============================
    m_hGeometryParameters["PbCylinder_oD"]            = 55. *mm;
    m_hGeometryParameters["PbCylinder_iD"]            = 35. *mm;
    m_hGeometryParameters["PbCylinder_Height"]        = 85. *mm;
    m_hGeometryParameters["PbCylinder_Bot_Thickness"] = 10. *mm;
...
void SCDetectorConstruction::ConstructWheel()
{
    ...
    G4double Spoke_Length    = GetGeometryParameter("Spoke_Length");
    G4double Paper_Thickness = GetGeometryParameter("Paper_Thickness");

    G4double Spoke_Width = Wheel_iD + (Wheel_oD-Wheel_iD)/2;
    ...
    G4UnionSolid* solid_Wheel1 = new G4UnionSolid(
        ...
        solid_Spoke,
        0,
        union_vector_Rim_Spoke
    );

    auto rotZ90 = new G4RotationMatrix();
    ...
    /* -- VisAttributes ---------------------------------------------------- */
    auto colour_Wheel = G4Colour(0.9, 0.9, 0., 1);
    ...
    logic_Paper = new G4LogicalVolume(
        solid_Paper, 
        Paper, 
        "logic_Paper"
    );
    ...
    /* Define special coordinate */
    zpos_PaperTop = zpos_Paper_centre + Paper_Thickness/2;

    /* -- VisAttributes ---------------------------------------------------- */
    auto colour_Paper = G4Colour(0., 0.4, 1., 0.7);
...
void SCDetectorConstruction::ConstructPbCylinder()
{
    ...
    /* Define special coordinate */
    zpos_PbCylinder_Inside_Floor = zpos_PaperTop + PbCylinder_Bot_Thickness;
